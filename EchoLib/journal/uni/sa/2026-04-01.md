...
- [x] get_dict_plaintext -> com plaintext converter a dicionario o que temos (retirar as flags de bytes) ✅ 2026-04-01
- [x] logread -> inclui verify_chain, plaintext decrypt (com funcao decrypt), get_dict_plaintext ✅ 2026-04-01
- [x] filtered results for 2nd comand of logread ✅ 2026-04-01
...
**Yes, os.urandom could theoretically repeat an IV — but the probability is so close to zero that it is considered cryptographically safe.**
